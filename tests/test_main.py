...
sys.path.insert(0, '/home/ubuntu/workspace/selection_sort') #change this to correct folder name
sys.path.insert(0, '/home/ubuntu/workspace/solution')

from main import selection_sort #change to proper function name
from solution import solved_selection_sort #change to proper function name
...
class test_cases(object):
    ...
    def tests(self): #add tests here
        f1,f2 = selection_sort, solved_selection_sort #change to proper function names
